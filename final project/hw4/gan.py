...
class Discriminator(nn.Module):
    def __init__(self, in_size):
        ...
        modules.append(nn.Conv2d(in_channels, channels[0],kernel_size=5, stride=2, padding=2))
        modules.append(nn.BatchNorm2d(channels[0]))
        modules.append(nn.ReLU())

        modules.append(nn.Conv2d(channels[0], channels[1],kernel_size=5, stride=2, padding=2))
        modules.append(nn.BatchNorm2d(channels[1]))
        modules.append(nn.ReLU())

        modules.append(nn.Conv2d(channels[1], channels[2], kernel_size=5, stride=2, padding=2))
